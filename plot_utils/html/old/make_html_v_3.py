...
with open(os.path.join(base_dir, 'variables.html'), 'w') as f:
    f.write(f'''
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <ul>
        <li><a href="variables/plots-1d.html">plots-1d</a></li>
        <li><a href="variables/plots-2d.html">plots-2d</a></li>
    </ul>
</body>
</html>
    ''')
...
# Create plots-1d
plots1d_dir = os.path.join(variables_dir, 'plots-1d')
os.makedirs(plots1d_dir, exist_ok=True)
with open(os.path.join(variables_dir, 'plots-1d.html'), 'w') as f:

    subdirectory_links = "\n".join([f'<li><a href="plots-1d/{subdir}/{subdir}.html">{subdir}</a></li>' for subdir in list_of_vars])
    f.write(f'''
<!DOCTYPE html>
<html lang="en">
<head>
...
for subdir in list_of_vars:
    subdir_path = os.path.join(plots1d_dir, subdir)
